...
def generate_synthetic_data(fa_file,total_no_seq,pure_seq_percent,seed_error_percent,xseed_error_percent,
    ...
    no_mir_chr, no_mir_chr_Y = sequence_calculation(total_no_seq, pure_seq_percent, depth,'None',gff_df)    
    fasta_seq = generate_sequence(fasta_seq,gff_df, rna_dict, no_mir_chr, no_mir_chr_Y, depth, 'None', out, ground_truth_filename,'write',repeat,distribution,seed)
    ...
    no_mir_chr, no_mir_chr_Y = sequence_calculation(total_no_seq, seed_error_percent, depth,'Seed_region',gff_df)    
    fasta_seq = generate_sequence(fasta_seq,gff_df, rna_dict, no_mir_chr, no_mir_chr_Y, depth, 'Seed_region', out, ground_truth_filename,'append',repeat,distribution,seed)
    ...
    no_mir_chr, no_mir_chr_Y = sequence_calculation(total_no_seq, xseed_error_percent, depth,'Outside_Seed_region',gff_df)    
    fasta_seq = generate_sequence(fasta_seq,gff_df, rna_dict, no_mir_chr, no_mir_chr_Y, depth, 'Outside_Seed_region', out, ground_truth_filename,'append',repeat,distribution,seed)
    ...
    if not repeat:
        gff_df = update_gff(gff_df,out,ground_truth_filename)
    no_mir_chr, no_mir_chr_Y = sequence_calculation(total_no_seq, both_error_percent, depth,'Both_region',gff_df)    
    fasta_seq = generate_sequence(fasta_seq,gff_df, rna_dict, no_mir_chr, no_mir_chr_Y, depth, 'Both_region', out, ground_truth_filename,'append',repeat,distribution,seed)
